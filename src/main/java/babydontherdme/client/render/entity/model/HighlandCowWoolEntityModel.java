...
public class HighlandCowWoolEntityModel<T extends HighlandCowEntity> extends QuadrupedEntityModel<T> {
    private float headAngle;

    public HighlandCowWoolEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("body", ModelPartBuilder.create().uv(20, 0).cuboid(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, new Dilation(0.8F)), ModelTransform.of(0.0F, 5.0F, 2.0F, 1.5707964F, 0.0F, 0.0F));
        ModelPartBuilder modelPartBuilder = ModelPartBuilder.create().uv(0, 16).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new Dilation(0.5F));
